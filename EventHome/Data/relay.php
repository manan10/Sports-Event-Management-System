...
<html lang="en">
	<head>
		<title> CO-Olympics | Cricket-Data </title>
		<meta charset="utf-8">
			...
			<div class="container-fluid">
				<div class="container col-md-2 col-lg-2 bor" style="background-color:#0d1a26;border-color: white;border-radius: 2px;">
					...
					<ul class="nav nav-pills nav-stacked" id="el" style="text-align:left">
						...
						<li class="active"><a style="color: white;font-size: 20px;" href="#">Relay race</a></li>
				...
				<div>
                    <?php   
                        ...
                        $stmt = $con->prepare("SELECT * FROM relay");
                        $stmt->execute();
                        $rows = $stmt->fetchAll();

                        echo "<h1 style=\"font-family:zcool xiaowei;color:white;\"> Relay Race </h1>  <br><br>";
                        echo "<table>";
                        echo "<tr> <th> ID </th> <th> Player 1 </th> <th> Contact No. </th> <th> Year </th> <th> Shift </th> </tr>"; 
