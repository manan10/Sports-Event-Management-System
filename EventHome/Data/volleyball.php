...
<html lang="en">
	<head>
		<title> CO-Olympics | Volleyball-Data </title>
		<meta charset="utf-8">
			...
			<div class="container-fluid">
				<div class="container col-md-2 col-lg-2 bor" style="background-color:#0d1a26;border-color: white;border-radius: 2px;">
					...
					<ul class="nav nav-pills nav-stacked" id="el" style="text-align:left">
						<li><a style="color: white;font-size: 20px;" href="#">Cricket</a></li>
						...
						<li class="active"><a style="color: white;font-size: 20px;" href="#">Volleyball</a></li>
				...
				<div>
                    <?php   
                        ...
                        $stmt = $con->prepare("SELECT * FROM volleyball");
                        $stmt->execute();
                        $rows = $stmt->fetchAll();

                        echo "<h1 style=\"font-family:zcool xiaowei;color:white;\"> Volleyball </h1>  <br><br>";
                        echo "<table>";
