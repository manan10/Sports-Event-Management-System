...
<html lang="en">
	<head>
		<title> CO-Olympics | Badminton-Singles Data </title>
		<meta charset="utf-8">
			...
			<div class="container-fluid">
				...
				<div>
                    <?php   
                        ...
                        $stmt = $con->prepare("SELECT * FROM bad_singles");
                        $stmt->execute();
                        $rows = $stmt->fetchAll();

                        echo "<h1 style=\"font-family:zcool xiaowei;color:white;\"> Badminton (Singles) </h1>  <br><br>";
                        echo "<table>";
