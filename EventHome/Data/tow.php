...
<html lang="en">
	<head>
		<title> CO-Olympics | Tug of War-Data </title>
		<meta charset="utf-8">
			...
			<div class="container-fluid">
				<div class="container col-md-2 col-lg-2 bor" style="background-color:#0d1a26;border-color: white;border-radius: 2px;">
					...
					<ul class="nav nav-pills nav-stacked" id="el" style="text-align:left">
						...
						<li class="active"><a style="color: white;font-size: 20px;" href="#">Tug of War</a></li>
				...
				<div>
                    <?php   
                        ...
                        $stmt = $con->prepare("SELECT * FROM tow");
                        $stmt->execute();
                        $rows = $stmt->fetchAll();

                        echo "<h1 style=\"font-family:zcool xiaowei;color:white;\"> Tug of War </h1>  <br><br>";
                        echo "<table>";
