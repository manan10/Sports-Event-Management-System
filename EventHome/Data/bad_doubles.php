...
<html lang="en">
	<head>
		<title> CO-Olympics | Badminton-Doubles Data </title>
		<meta charset="utf-8">
			...
			<div class="container-fluid">
				...
				<div>
                    <?php   
                        ...
                        $stmt = $con->prepare("SELECT * FROM bad_doubles");
                        $stmt->execute();
                        $rows = $stmt->fetchAll();

                        echo "<h1 style=\"font-family:zcool xiaowei;color:white;\"> Badminton (Doubles) </h1>  <br><br>";
                        echo "<table>";
