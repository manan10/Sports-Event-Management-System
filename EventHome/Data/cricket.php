			...
			<div class="container-fluid">
				<div class="container col-md-2 col-lg-2 bor" style="background-color:#0d1a26;border-color: white;border-radius: 2px;">
					...
					<ul class="nav nav-pills nav-stacked" id="el" style="text-align:left">
						<li class="active"><a style="color: white;font-size: 20px;" href="#">Cricket</a></li>
				...
				<div>
                    <?php   
                        ...
                        $stmt = $con->prepare("SELECT * FROM cricket");
                        $stmt->execute();
                        $rows = $stmt->fetchAll();

                        echo "<h1 style=\"font-family:zcool xiaowei;color:white;\"> Cricket </h1>  <br><br>";
                        echo "<table>";
