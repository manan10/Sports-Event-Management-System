...
<html lang="en">
	<head>
		<title> CO-Olympics | Chess-Data </title>
		<meta charset="utf-8">
			...
			<div class="container-fluid">
				<div class="container col-md-2 col-lg-2 bor" style="background-color:#0d1a26;border-color: white;border-radius: 2px;">
					...
					<li><a style="color: white;font-size: 20px;" href="cricket.php">Cricket</a></li>
						...
						<li class="active"><a style="color: white;font-size: 20px;" href="#">Chess</a></li>
				...
				<div>
                    <?php   
                        ...
                        $stmt = $con->prepare("SELECT * FROM chess");
                        $stmt->execute();
                        $rows = $stmt->fetchAll();

                        echo "<h1 style=\"font-family:zcool xiaowei;color:white;\"> Chess </h1>  <br><br>";
                        echo "<table>";
